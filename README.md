...
Welcome to the Upgrade Your Bumper—Public Repository, a rogue-lite racing game developed in Unity 3D using the Built-In Rendering Pipeline.
...
- **Engine:** Unity 3D (Built-in Rendering Pipeline) version 2023.2.20f1
